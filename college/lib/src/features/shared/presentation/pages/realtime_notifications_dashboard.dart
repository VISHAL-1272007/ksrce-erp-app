    ...
    return Consumer<DataService>(
      builder: (context, ds, _) {
        return Scaffold(
          ...
          floatingActionButton: ds.currentUserId?.startsWith('STU') == true
              ? null
              : FloatingActionButton.extended(
                  onPressed: () {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(content: Text('Send Notification dialogue will be implemented here.')),
                    );
                  },
                  icon: const Icon(Icons.send, color: Colors.white),
                  label: const Text('Send Notice', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
