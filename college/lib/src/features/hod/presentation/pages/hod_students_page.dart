                  ...
                  SingleChildScrollView(
                    ...
                    child: DataTable(
                      ...
                      rows: classStudents.map((s) {
                        ...
                        return DataRow(
                          cells: [
                            DataCell(Text((s['roll_no'] ?? s['studentId'] ?? '').toString(), style: const TextStyle(fontWeight: FontWeight.bold))),
                            DataCell(Text((s['name'] ?? 'Unknown').toString())),
                            DataCell(Text((s['email'] ?? '').toString())),
                            DataCell(Text((s['phone'] ?? '').toString())),
                            DataCell(Text(mentorName)),
                            DataCell(Text((s['cgpa'] ?? 'N/A').toString())),
                          ],
                        );
                      }).toList(),
                    ),
