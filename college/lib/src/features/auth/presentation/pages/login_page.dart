...
class _LoginPageState extends State<LoginPage> with SingleTickerProviderStateMixin {
  ...
  final List<String> _placeholders = ['Eg. STU001', 'Eg. FAC001', 'Eg. admin@ksrce.ac.in'];
  ...
  Future<void> _login() async {
    ...
    final result = await authService.login(userId, password, _rememberMe);
    ...
    if (result.success) {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(result.message.isNotEmpty ? result.message : 'Invalid User ID or password. Please try again.'),
          ...
          children: [
            ...
            Container(
              ...
              child: TabBar(
                ...
                tabs: List.generate(roles.length, (i) => Tab(
                  child: Row(
